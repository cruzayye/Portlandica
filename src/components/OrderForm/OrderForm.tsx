    ...
    <>
      <Paper elevation={2} sx={{ p: 4, maxWidth: 560, width: '100%' }}>
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
          ...
          <FormControlLabel
            control={
              <Switch checked={form.isDonation ?? false} onChange={handleSwitch('isDonation')} />
            }
            label="Donut"
          />
        </Box>
        ...
        <Box component="form" onSubmit={handleSubmit} display="flex" flexDirection="column" gap={3}>
          ...
          <Box display="flex" gap={2} flexWrap="wrap">
            <FormControlLabel
              control={
                <Switch checked={form.isStill ?? false} onChange={handleSwitch('isStill')} />
              }
              label="Still"
            />
            <FormControlLabel
              control={
                <Switch checked={form.isSpark ?? false} onChange={handleSwitch('isSpark')} />
              }
              label="Sparkling"
            />
            <FormControlLabel
              ...
              control={
                <Switch
                  ...
                  onChange={(e) =>
                    setForm((prev) => ({
                      ...prev,
                      deliveryType: e.target.checked ? 'Pickup' : null,
                    }))
                  }
                />
              }
          ...
          <Button
            ...
            size="large"
            disabled={
              isPending || !form.name || (!form.isStill && !form.isSpark) || !form.deliveryType
            }
          >
